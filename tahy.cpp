...
while (PT==false)
{
    ...
    kontrola_sachu(P,M,T1,T2,TK1,TK2,k,l,ik1,jk1,ik2,jk2,H,T,SACH,NT,POCPT,POCPTK,ZT);
    std::cout<<"Sach 1"<<SACH[1]<<std::endl;
    if(SACH[1]==1)
  ...
  //  else {std::cout<<"Zadana pozice obsahuje hratelnou figurku"<<std::endl;}
   ...
   // else {std::cout<<"Zadana pozice neni obsazena"<<std::endl;}
    ...
    if(P[iv][jv]=='p') {
            ...
            if (H==1){
                                    tahp1(P,PP,M,MP,T1,T2,iv1,ic1,jv1,jc1,k,l,H,T,NT);


                            }
                            else {
                                    tahp2(P,PP,M,MP,T2,T1,iv2,ic2,jv2,jc2,k,l,H,T,NT);
...
char tahp1 (char P[10][10], char PP[10][10],int M[10][10],int MP[10][10], int T1[10][10],int T2[10][10], int iv1, int ic1, int jv1, int jc1, int k, int l, int H, bool T,int NT[3]){   //funkce ktera definuje tahy pesce 1, cili bileho hrace
    int i;
    int j;
    bool PT1;
    bool PT2;
...
char tahk (char P[10][10], char PP[10][10],int M[10][10],int MP[10][10], int T1[10][10],int T2[10][10],int TK1[10][10],int TK2[10][10], int iv1, int ic1, int jv1, int jc1, int iv2, int ic2, int jv2, int jc2,int k, int l,  int ik1, int jk1, int ik2,int jk2, int H,bool T,int NT[3])
{
   ...
   if (M[i+1][j]!=1&&T2[i+1][j]==0&&i<8)        //tahy nahoru
     ...
     if (M[i-1][j]!=1&&T2[i-1][j]==0&&i>1)      //tahy dolu
        ...
        if (M[1][j+1]!=1&&T2[i][j+1]==0&&j<8)      //tahy doprava
        {
            T1[i][j+1]=1;
            TK1[i][j+1]=1;
        }
     ...
     if (M[i-1][j+1]!=1&&T2[i-1][j+1]==0&&i>1&&j<8)      //tahy diagonalne vpravo dolu
        ...
        if (M[1+1][j-1]!=1&&T2[i+1][j-1]==0&&i<8&&j>1)   //tahy diagonalne vlevo nahoru
        {
            T1[i+1][j-1]=1;
            TK1[i+1][j-1]=1;
        }
   ...
   if (M[i+1][j]!=2&&T1[i+1][j]==0&&i<8)        //tahy nahoru
     ...
     if (M[i-1][j]!=2&&T1[i-1][j]==0&&i>1)      //tahy dolu
        ...
        if (M[1][j+1]!=2&&T1[i][j+1]==0&&j<8)      //tahy doprava
        {
            T2[i][j+1]=2;
            TK2[i][j+1]=2;
        }
     ...
     if (M[i-1][j+1]!=2&&T1[i-1][j+1]==0&&i>1&&j<8)      //tahy diagonalne vpravo dolu
        ...
        if (M[1+1][j-1]!=2&&T1[i+1][j-1]==0&&i<8&&j>1)   //tahy diagonalne vlevo nahoru
        {
            T2[i+1][j-1]=2;
            TK2[i+1][j-1]=2;
        }
